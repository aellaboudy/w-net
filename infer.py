...
def main(args):
    ...
    data_generator, _ , data_filenames, _ = get_data_generators('/home/ubuntu/kitti_competition/',
                                                     '/home/ubuntu/kitti_competition/', 
                                                     batch_size=1,
    ...
    #		print os.path.basename(data_filenames[i])
	#	depth_left = dat[0][0,...]
...
#		plt.figure(figsize=(15,5))
    ...
    #		plt.axis('off')
    #		plt.subplot(1,2,1)
    #		plt.imshow(depth_left, cmap=plt.cm.jet)
    #		plt.axis('off')
